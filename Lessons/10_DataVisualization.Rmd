...
O3plot7 <- ggplot(EPAair, aes(x = Date, y = Ozone)) +
  ...
  ylab(expression("O"[3]* " AQI Value")) + ###The brackets around 3 will subscript 3. To superscript, use a caret.
  theme(axis.text.x = element_text(angle = 45,  hjust = 1))   #Adds Y-axis label and position
###Define element of text and put it at an angle of 45 degrees. hjust is the horizontal justification. Hjust of 1 moves it to the left
